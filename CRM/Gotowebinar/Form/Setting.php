...
class CRM_Gotowebinar_Form_Setting extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    //DM: Validating if the tokens exist, if the tokens are invalid then refreshing the tokens
    $validToken = FALSE;
  ...
  public function postProcess() {
    ...
    if(isset($params['participant_status_id']) && !empty($params['participant_status_id'])){
  ...
  static function apiCall(
    ...
    curl_close($curl);
    CRM_Core_Error::debug_var('apiResponse',$apiResponse);
    return $apiResponse;
  }//DM
